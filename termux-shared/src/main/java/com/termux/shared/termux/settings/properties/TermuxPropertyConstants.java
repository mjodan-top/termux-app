...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'MENU','UP','BKSP','END','HOME'], ['TAB','CTRL',{key: 'KEYBOARD_TAB', display: 'Tab'},'LEFT','DOWN','RIGHT',{key: 'IME', display: 'IME'},'ENTER']]"; // Double row
